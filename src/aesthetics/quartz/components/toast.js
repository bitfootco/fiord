    (function () {
      ...
      var VARIANTS = {
        success: {
          ...
          classes: 'bg-white dark:bg-quartz-900 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200',
          iconClasses: 'text-[#059669]',
        ...
        error: {
          ...
          classes: 'bg-white dark:bg-quartz-900 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200',
        ...
        warning: {
          ...
          classes: 'bg-white dark:bg-quartz-900 border border-amber-200 dark:border-amber-700 text-amber-800 dark:text-amber-200',
        ...
        info: {
          ...
          classes: 'bg-white dark:bg-quartz-900 border border-cyan-200 dark:border-cyan-800 text-[#164E63] dark:text-cyan-200',
      ...
      function showToast(type) {
        ...
        toast.className = [
          'pointer-events-auto flex items-start gap-3 w-80 px-4 py-3 rounded-md shadow-lg shadow-quartz-900/10',
